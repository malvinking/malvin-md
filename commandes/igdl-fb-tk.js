  ...
  try {
    ...
    .then((result) => {
      ...
      `;
       ...
       zk.sendMessage(dest, { video: { url: result.hd  }, caption: 'facebook video downloader powered by *ᴍᴀʟᴠɪɴ-ᴍᴅ*' }, { quoted: ms });
  ...
  try {
    ...
    .then((result) => {
      ...
      `;
       ...
       zk.sendMessage(dest, { video: { url: result.sd  }, caption: 'facebook video downloader powered by *ᴍᴀʟᴠɪɴ-ᴍᴅ*' }, { quoted: ms });
